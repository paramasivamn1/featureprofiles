...
* Ensure the member ports are on different linecards (e.g., `Linecard 1` and `Linecard 2`).
...
* **Step 1: Configure Traffic**
  ...
  * The traffic should be distributed across all member links of the bundle.
